...
const searchResults = (props) => {
  console.log(props);
  return (
    <div class="ui card" onClick={() => props.selectTrack(props.result.album.external_urls.spotify)} style={{backgroundColor: '#1d1d1e', color: '#fff', textAlign: 'center', opacity: 1}}>
